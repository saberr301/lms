...
import { signUp } from "../../../services/operations/authAPI"; // Nouvelle fonction d'inscription
...
function SignupForm() {
  ...
  // ✅ Modifier la soumission du formulaire pour supprimer l'OTP
  const handleOnSubmit = async (e) => {
    ...
    try {
      // ✅ Envoyer directement l'inscription au backend
