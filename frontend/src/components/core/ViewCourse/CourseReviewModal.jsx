        ...
        <div className="p-6">
          <div className="flex items-center justify-center gap-x-4">
            ...
            <div className="">
              ...
              <p className="text-sm text-richblack-5">Publier</p>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex w-11/12 flex-col space-y-2">
              ...
              >
                Ajoutez votre expérience <sup className="text-pink-200">*</sup>
              </label>
              <textarea
                id="courseExperience"
              ...
              {errors.courseExperience && (
                <span className="ml-2 text-xs tracking-wide text-pink-200">
                  Veuillez ajouter votre expérience
                </span>
              )}
            </div>
