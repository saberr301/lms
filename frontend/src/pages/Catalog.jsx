  ...
  if (!loading && !catalogPageData) {
    return (
      <div className="text-white text-4xl flex justify-center items-center mt-[20%]">
        Aucun cours trouvé pour la catégorie sélectionnée
      </div>
    );
  }
    ...
    <>
      ...
      <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
        <div className="section_heading">
          Des cours pour vous aider à démarrer
        </div>
      ...
      <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
        <div className="section_heading">
          Meilleurs cours en {catalogPageData?.differentCategory?.name}
        </div>
        <div>
          <Course_Slider
      ...
      {/* Section 3 
      <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
        <div className="section_heading">Fréquemment regardét</div>
        <div className="py-8">
